...
function CreateCabinForm({ cabinToEdit = {}, onCloseModal }) {
  ...
  const { isPending: isWorking, mutate } = useCreateCabin({ reset, isEditSession })
      ...
      <FormRow>
        ...
        <Input
          ...
          {...register("discount", {
            ...
            valueAsNumber: true,
            validate: (value) =>
              value <= getValues().regularPrice || "Discount cannot exceed price",
          })}
          disabled={isWorking}
        />
